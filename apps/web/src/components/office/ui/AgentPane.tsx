...
const ChatMessageList = memo(function ChatMessageList({
  ...
  return (
    <>
      ...
      {messages.length === 0 && (
        <TermEmpty
          message={isTeamMember ? "no messages yet" : "no messages yet"}
          hint={isTeamMember ? "send a message or wait for team lead" : "send a message to get started"}
        />
      )}
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                    <div className="term-input-well">
                      ...
                      <textarea
                        ...
                        placeholder={busy ? "esc stop · type to continue" : "send a message to this agent..."}
                        style={{
                    ...
                    <span style={{ padding: "2px 8px", color: TERM_DIM, fontSize: 11, fontFamily: TERM_FONT }}>
                      team member · direct message
                    </span>
                  </div>
                ) : cardPhase === "execute" ? (
                  <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
