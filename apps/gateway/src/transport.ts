...
export interface Channel {
  ...
  init(commandHandler: (cmd: Command | { type: string; [key: string]: any }, meta: CommandMeta) => void): Promise<boolean>;
...
let storedCommandHandler: ((cmd: Command | { type: string; [key: string]: any }, meta: CommandMeta) => void) | null = null;
...
export async function initTransports(commandHandler: (cmd: Command | { type: string; [key: string]: any }, meta: CommandMeta) => void) {
